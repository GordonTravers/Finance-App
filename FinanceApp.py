...
def compare_performance():
    ...
    if stock_data is not None and sp500_data is not None:
        # Calculate the performance of the stock and the S&P 500 during the specified time period
        ...
        # Display the historical information of the stock
        ...
        # Get and display the stock news
        articles = get_stock_news(symbol)
        if articles is not None:
            news_text.delete("1.0", "end")  # Clear previous text
...
#Code belkow is for the organization of a the user interface
